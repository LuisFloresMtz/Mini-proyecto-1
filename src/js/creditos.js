document.addEventListener("DOMContentLoaded", () => {
    ...
    // Bucle de animación para mover los sujetos y hacerlos rebotar
    ...
    function onPointerUp(e) {
      ...
      // Al soltar, verificar si el centro del sujeto está en alguna drop zone
      ...
      dropZones.forEach(zone => {
        ...
        if (
          ...
          // Drop correcto si coinciden los identificadores
